...
const InputConvert = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement(Box$1, {
...
const RecipientStep = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    htmlFor: "recipient"
  }, "Recicipent Wallet"), showRefundAddressInput ? /*#__PURE__*/React__default['default'].createElement("button", {
    className: "text-sm",
    onClick: () => {
      dispatch({
        type: "refundAddress",
  ...
  }, "Add refund address")), availableRecipients.length ? /*#__PURE__*/React__default['default'].createElement("select", {
    name: "recipient",
    value: recipient,
    onChange: evt => dispatch({
      type: "recipient",
  ...
  }, "Refund Wallet"), /*#__PURE__*/React__default['default'].createElement("input", {
    name: "refund-address",
    type: "text",
